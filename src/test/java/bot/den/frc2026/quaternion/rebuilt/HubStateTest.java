...
public class HubStateTest {
    ...
    void whenTheMatchStateGoesBackToNoneTheHubIsInactive(MatchState startingState) {
        ...
        var machine = new RebuiltStateMachine(startingState, HubState.ACTIVE, ShooterState.OFF);
        HubState.setup(machine);
    ...
    void goThroughShifts(Alliance us, Alliance autoPoints) {
        ...
        var machine = new RebuiltStateMachine(MatchState.TRANSITION_SHIFT, HubState.ACTIVE, ShooterState.OFF);
        HubState.setup(machine);
