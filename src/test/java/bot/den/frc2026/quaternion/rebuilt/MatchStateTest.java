...
public class MatchStateTest {
    ...
    void nothingHappensWhileRobotIsDisabled() {
        var machine = new RebuiltStateMachine(MatchState.NONE, HubState.INACTIVE, ShooterState.OFF, ShooterHoodState.NONE);
    ...
    void matchStateGoesBackToNoneAfterTwentySeconds() {
        var machine = new RebuiltStateMachine(MatchState.AUTO, HubState.INACTIVE, ShooterState.OFF, ShooterHoodState.NONE);
        MatchState.setup(machine);
    ...
    void matchStateMovesFromTransitionShiftToShiftOne() {
        setDriverStationState(RobotState.TELEOP);
        var machine = new RebuiltStateMachine(MatchState.TRANSITION_SHIFT, HubState.INACTIVE, ShooterState.OFF, ShooterHoodState.NONE);
        MatchState.setup(machine);
    ...
    void matchStateMovesFromShiftOneToShiftTwo() {
        setDriverStationState(RobotState.TELEOP);
        var machine = new RebuiltStateMachine(MatchState.SHIFT_1, HubState.INACTIVE, ShooterState.OFF, ShooterHoodState.NONE);
        MatchState.setup(machine);
    ...
    void matchStateMovesFromShiftTwoToShiftThree() {
        setDriverStationState(RobotState.TELEOP);
        var machine = new RebuiltStateMachine(MatchState.SHIFT_2, HubState.INACTIVE, ShooterState.OFF, ShooterHoodState.NONE);
        MatchState.setup(machine);
    ...
    void matchStateMovesFromShiftThreeToShiftFour() {
        setDriverStationState(RobotState.TELEOP);
        var machine = new RebuiltStateMachine(MatchState.SHIFT_3, HubState.INACTIVE, ShooterState.OFF, ShooterHoodState.NONE);
        MatchState.setup(machine);
    ...
    void matchStateMovesFromShiftFourToEndGame() {
        setDriverStationState(RobotState.TELEOP);
        var machine = new RebuiltStateMachine(MatchState.SHIFT_4, HubState.INACTIVE, ShooterState.OFF, ShooterHoodState.NONE);
        MatchState.setup(machine);
    ...
    void matchStateGoesBackToNoneAfterEndGame() {
        setDriverStationState(RobotState.TELEOP);
        var machine = new RebuiltStateMachine(MatchState.END_GAME, HubState.INACTIVE, ShooterState.OFF, ShooterHoodState.NONE);
        MatchState.setup(machine);
    ...
    void matchStateBecomesNoneAsSoonAsRobotIsDisabled(MatchState matchState, RobotState robotState) {
        ...
        var machine = new RebuiltStateMachine(matchState, HubState.INACTIVE, ShooterState.OFF, ShooterHoodState.NONE);
        MatchState.setup(machine);
